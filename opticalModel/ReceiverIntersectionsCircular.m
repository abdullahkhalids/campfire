function [indexes,isIntersection] = ReceiverIntersectionsCircular(gradientsReflected,trough,receiver,sun)
...
[pointsIntersections,isIntersection] = LineLineSegmentIntersections(coordinates,gradientsReflected,receiver.radius*2,receiver.position);
